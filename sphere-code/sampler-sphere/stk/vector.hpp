...
//~ /**
 ...
 //~ */
	//~ Vector<DIM, T>(const Vector<DIM, T>& i_vect)
	//~ {
		//~ for(unsigned int i=0; i<DIM; i++)
			//~ m_vals[i] = i_vect[i];
	//~ }
